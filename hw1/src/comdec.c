        ...
        if(c==0x83){ // new block
            ...
            do{
                ...
                if(((byte1 & 0xe0) >> 4) == 0xc){ // two bytes
                    ...
                    // fprintf(stderr, "The head of a rule needs to be a non terminal symbol\n");
                    return EOF;
                }
